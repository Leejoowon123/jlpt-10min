...
✅ **N3 3차 안정화 / N3 완성 (라운드 39)** — 전수 감사 **0 이슈**. 회귀 방지 잠금 추가
   (전역 replace 손상·sourceId 손상·scriptReadings 혼입·선택지 N2 패턴 — 모두 smoke blocking),
   학습범위 밖 한자 62건 최종 정책(한도 75) 확정, 장문 독해/story UX 검증.
   **N3 완성 선언 기준(누적 vocab 2700·kanji 600·grammar 120·r/l 80·후리가나 100%·의존성 전수·
   전역 중복 0·N2 참조 0·unreviewed 0) 전부 충족 → N3 완성.** qa [206]~[211].
